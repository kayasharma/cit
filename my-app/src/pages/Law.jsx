  ...
  return (
    <section className="price" id="price">
      <h1 className="heading">
        law <span>events</span>
      </h1>

      <div className="box-container">
        <div className="box">
          <h3 className="title">black bull</h3>
        ...
        <div className="box">
          <h3 className="title">crazy leg</h3>
          <h3 className="amount">prizes</h3>
          <ul>
            <li>
              <i className="fas fa-check"></i>First Runner up: ₹1000
        ...
        <div className="box">
          <h3 className="title">extempore</h3>
          <h3 className="amount">prizes</h3>
          <ul>
            <li>
              <i className="fas fa-check"></i>First Runner up: ₹1000
        ...
        <div className="box">
          <h3 className="title">hot seat</h3>
          <h3 className="amount">prizes</h3>
          <ul>
            <li>
              <i className="fas fa-check"></i>First Runner up: ₹1000
        ...
        <div className="box">
          <h3 className="title">legal disputes</h3>
          <h3 className="amount">prizes</h3>
          <ul>
            <li>
              <i className="fas fa-check"></i>First Runner up: ₹1000
